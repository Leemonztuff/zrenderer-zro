  ...
  return (
    <div style={{ width: '100vw', height: '100vh', background: '#222' }}>
      ...
      <div style={{ position: 'absolute', top: 20, left: 20, color: 'white', fontFamily: 'sans-serif', pointerEvents: 'none' }}>
        ...
        <div style={{ pointerEvents: 'auto', display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '20px' }}>
          ...
          <button onClick={() => setJob([4001])} style={{ padding: '8px 16px', cursor: 'pointer' }}>Lord Knight</button>
          <button onClick={() => setGender(gender === 0 ? 1 : 0)} style={{ padding: '8px 16px', cursor: 'pointer' }}>
            Cambiar Género ({gender === 0 ? 'F' : 'M'})
          </button>
          ...
          <button onClick={() => setAction(12)} style={{ padding: '8px 16px', cursor: 'pointer' }}>Attack</button>
        </div>
      </div>
    </div>
  );
