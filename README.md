...
Para una experiencia completa, utiliza nuestro [Template de RPG Táctico](examples/rpg-tactic-template/README.md) que ya incluye un servidor proxy en Node y un cliente React con Three.js configurados.
